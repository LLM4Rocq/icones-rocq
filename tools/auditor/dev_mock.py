    ...
    section_5 = {
        ...
        "entries": [
            ...
            _entry(
                ...
                ["beyond-paper"],
                ["EMComon_all"],
                [_file("theories/cbv/em_cartesian.v")],
    ...
    beyond = [
        {
            ...
            "entries": [
                {"label": "Subobject classifier on ICones",
                 ...
                 "rocq_files": [_file("theories/homs/representable.v")]},
                {"label": "Wide intersection + UMP",
                 "rocq_idents": ["wi_obj", "wi_med", "wi_med_proj"],
                 "rocq_files": [_file("theories/homs/representable.v")]},
            ],
            "snippets": [_snippet("theories/homs/representable.v", "Section WideIntersection",
    ...
    return {
        ...
        "axiom_anchors": {
            ...
            "headlines": [
                ...
                "Icones.exp.seely.ICones_Seely",
                "Icones.exp.coalgebra.FMeas_coalgebra",

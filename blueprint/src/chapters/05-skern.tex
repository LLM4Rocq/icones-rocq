...
\section{Paper Theorem 6.1: \texorpdfstring{$\Path(X, B) \simeq \FMeas(X) \lin B$}{Path(X, B) ~= FMeas(X) -> B}}%
\label{sec:thm61}
...
\subsection{The Dirac path \texorpdfstring{$\delta_X$}{delta_X}}\label{sec:dirac-path}
...
\subsection{The forward map \texorpdfstring{$I^B_X$}{I^B_X}}\label{sec:int-to-linhom}
...
\subsection{The inverse map \texorpdfstring{$K^B_X$}{K^B_X}}\label{sec:linhom-to-int}
...
\subsection{Round-trip \texorpdfstring{$K \circ I = \id$}{K . I = id}}\label{sec:KI-roundtrip}
...
\subsection{Round-trip \texorpdfstring{$I \circ K = \id$}{I . K = id}}\label{sec:IK-roundtrip}
...
\section{The category \texorpdfstring{$\Skern$}{Skern}}\label{sec:skern}
...
\section{The functor \texorpdfstring{$\Skern \to \ICones$}{Skern to ICones}}\label{sec:skern-to-icones}
...
\paragraph{\texorpdfstring{$\FMeas$}{FMeas} vs.\ \texttt{\{finite\_measure\}}.}
...
\paragraph{Why \texorpdfstring{$I^B_X$}{I^B_X} is not packaged as an \texorpdfstring{$\MCones$}{MCones}-iso.}

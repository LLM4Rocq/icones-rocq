...
\begin{itemize}
  ...
  \item \emph{Naturality of $\Phi$.} Naturality in $D$ stated
    existentially
    (\rocq{Icones.homs.tensor.tensor_curry_natural_D}\rocqok{}),
    naturality in $B$
    (\rocq{Icones.homs.tensor.tensor_curry_natural_B}\rocqok{}),
  ...
  \item \emph{Structural-iso existence and their computation laws (paper
    ...
    with
    \rocq{Icones.homs.tensor.tensor_assocE}\rocqok{}, the
    unitors
    \rocq{Icones.homs.tensor.tensor_lunit_iso}\rocqok{}
    /
    \rocq{Icones.homs.tensor.tensor_runit_iso}\rocqok{}
    with
    \rocq{Icones.homs.tensor.tensor_lunitE}\rocqok{} /
    \rocq{Icones.homs.tensor.tensor_runitE}\rocqok{}, and
    the braiding
    \rocq{Icones.homs.tensor.tensor_braid_iso}\rocqok{}
    with
    \rocq{Icones.homs.tensor.tensor_braidE}\rocqok{}.
\end{itemize}
...
\rocq{Icones.homs.tensor.tensor_assocE} etc.\ of \texttt{tensor\_iso.v}
(\S\ref{sec:tensor-staging}).
\end{definition}

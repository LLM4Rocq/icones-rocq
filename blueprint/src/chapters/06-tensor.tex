...
\begin{itemize}
  ...
  \item \emph{Naturality of $\Phi$.} Naturality in $D$ stated
    ...
    (\rocq{Icones.homs.tensor.tensor_curry_natural_post}\rocqok{}).
...
(\rocq{Icones.homs.tensor.tensor_curry_natural_post},
...
\rocq{Icones.homs.tensor.tensor_curry_natural_post}), the Thm~5.12

...
(* the five universal-arrow primitives consumed by [exp_adjunction.v]:        *)
(*                                                                            *)
(*   Bang, nl, lin, lin_beta, lin_unique                                      *)
(*                                                                            *)
(* It is AXIOM-FREE relative to the classical [boolp] base — NO               *)
(* [Axiom]/[Parameter]/[Admitted].  The definitions live in their own         *)
(* module [Icones.homs.bang_construct].                                       *)
(*                                                                            *)
(* This is the EXACT exponential analog of [theories/homs/tensor_construct.v] *)
(* (the tensor construction), with the limit-preserving functor [R := Der]   *)
